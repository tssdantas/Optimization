...
- ### Optimization of a test function in the C++ language.
    -  [Simulated Annealing](https://github.com/tssdantas/Optimization_Portfolio/tree/main/SimulatedAnnealing) An algorithm in C++11 was built from scratch to implement the Simulated Annealing optimization method, which can be classified as a stochastic, heuristic and a global optimization approach. A two dimensional Rastrigin test function with an optimum solution in x = (0, 0) was used for demonstration purposes. 
